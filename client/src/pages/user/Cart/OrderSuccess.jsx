...
const OrderSuccess = () => {
    ...
    useEffect(() => {
        const savePayment = async () => {
            try {
                ...
                console.log(error);
                // *** THIS IS THE FIX ***
                // If the save fails, stop loading and go to the failed page
                setLoading(false);
    ...
    }, [sessionId, auth?.token, cartItems, hasSavedPayment, setCartItems, navigate, setCartItems]); // Added navigate and setCartItems to dependency array
